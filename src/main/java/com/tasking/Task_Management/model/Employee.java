...
public class Employee {
	...
	public Employee(int employee_id, String employee_name, String employee_email, int current_project_id,
			int team_leader_id, int manager_id, int hr_id, int task_id, int is_hr, int is_manager, int is_tl) {
	...
	public void setIs_hr(int is_hr) {
		this.is_hr = is_hr;
	}
